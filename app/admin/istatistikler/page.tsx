...
export default function StatisticsPage() {
  ...
  return (
    <RoleGate
      ...
      fallback={<Unauthorized message="İstatistikler sayfasına erişim için yönetici veya admin yetkisi gereklidir." />}
    >
      <PermissionGate
        permissionNeeded="view:statistics"
        fallback={<Unauthorized message="İstatistikler görüntüleme izniniz bulunmamaktadır." />}
      >
